...
import { PlusCircle, Star, Edit3, Building2, MapPin } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 sm:mb-8">
        <div>
          <h1 className="text-xl sm:text-2xl md:text-3xl font-extrabold text-neutral-900 dark:text-white tracking-tight">
            Valpromark Host Management
          </h1>
          <p className="text-xs sm:text-sm text-neutral-500 dark:text-neutral-400 mt-1">
            Manage your Ghana rental accommodations, rates, and guest calendar
          </p>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="max-w-md mx-auto my-12 sm:my-16 p-6 sm:p-8 text-center bg-white dark:bg-[#0F1E33] rounded-3xl border border-neutral-200 dark:border-[#1E3557] space-y-4 shadow-sm">
          ...
          <p className="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">
            Partner with Valpromark Essence to list your apartment, villa, or boutique retreat in Ghana.
          </p>
          <Link
            to="/host/create"
            ...
            >
              ...
              <div className="flex items-center gap-2 mt-4 pt-3 border-t border-neutral-100 dark:border-[#1E3557]/80">
                <Link
                  ...
                  className="flex-1 py-2 rounded-xl text-center text-xs font-bold bg-[#0A1422] text-[#C5A059] hover:bg-[#0E1E38] transition-colors border border-[#1E3557]"
                >
                  Preview Stay
                </Link>
                <Link
                  to="/host/create"
                  className="p-2 rounded-xl border border-neutral-200 dark:border-[#1E3557] hover:border-[#C5A059] text-neutral-600 dark:text-neutral-300"
                  title="Edit details"
                >
